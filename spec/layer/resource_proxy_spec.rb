  ...
  describe "#url" do
    context "with base resource present" do
      it "should return combination of base & target resource urls" do
        base_url = "base"
        target_url = "target"
        base_resource = Layer::Resource.new({"url" => base_url})
        target_resource = Layer::Resource.new({"url" => target_url})

        resource_proxy = Layer::ResourceProxy.new(base_resource, target_resource)
    ...
    context "with no base resource present" do
      it "should return target resource url" do
        ...
        resource_proxy = Layer::ResourceProxy.new(nil, target_resource)
